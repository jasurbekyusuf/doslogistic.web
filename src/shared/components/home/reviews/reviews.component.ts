...
export class ReviewsComponent {
  ...
  slides = [
    { id: 1, text: "I can confidently say they are a top-notch logistics partner. Their commitment to reliability and efficiency has greatly benefited our business. From the moment we started collaborating, they demonstrated a deep understanding of our specific needs and industry." },
    ...
    { id: 6, text: "Moreover, their team is highly professional and responsive. Any questions or concerns are addressed promptly. We've experienced consistent on-time deliveries, and their attention to detail in handling our products has minimized any risk of damage during transit." },
    { id: 6, text: "Что меня больше всего впечатляет в «Дост Логистик», так это их адаптируемость. Они плавно масштабировали свои услуги, будь то обработка увеличенного объема в пиковые сезоны или поиск экономически эффективных решений для специализированных грузов." }
  ];
}
